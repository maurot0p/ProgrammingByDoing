...
public class PokeSwap
{
	public static void main(String[] args)
	{
		...
		if ( choice == 2 )
		{
			...
			String replace= pokeParty[3];// add code here to swap Pikachu (slot 0) with Gyarados (slot 3)

			System.out.println( replace + " used BITE!  It's super effective." );
			...
			System.out.println( replace + " gained 155 EXP. Points!" );
